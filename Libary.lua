-- =============================================
-- AZZURA UI Library v1.0
-- by AZZURA
-- Red-Black Theme
-- =============================================

pcall(function()
    game:GetService('CoreGui'):FindFirstChild('AZZURA_UI'):Remove()
end)
...
function Library:Window(title)
    ...
    local function MinimizeUI()
        ...
        if isMinimized then
            -- Sembunyikan isi UI, tampilkan label kecil
